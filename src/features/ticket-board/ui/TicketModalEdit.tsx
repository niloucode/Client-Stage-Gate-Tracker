	...
	async function handleSave() {
		...
		const updated = await updateTicketMutation.mutateAsync({
			...
			plan_start_at: ticket.plan_start_at
				...
				: undefined,
			plan_end_at: ticket.plan_end_at
				? new Date(ticket.plan_end_at)
				: new Date(),
				...
				<div className="flex-1 overflow-y-auto [scrollbar-gutter:stable]">
					...
					<div className="px-5 mt-3">
						<div className="flex justify-between">
							...
							<span className="text-sm text-neutral-border/75">
								1 of 2 complete
							</span>
						</div>
			...
			<div className="grid grid-cols-2 gap-4">
				...
				<div>
					...
					<DateTimePicker
						...
						onChange={(date) =>
							setTicket((t) =>
								t ? { ...t, plan_start_at: date ?? t.plan_start_at } : t,
							)
						}
				...
				<div>
					...
					<DateTimePicker
						...
						onChange={(date) =>
							setTicket((t) =>
								t ? { ...t, plan_end_at: date ?? t.plan_end_at } : t,
							)
						}
