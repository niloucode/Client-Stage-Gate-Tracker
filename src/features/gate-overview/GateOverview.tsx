    ...
    <main className="min-h-screen w-full bg-background px-10 py-8">
      <div className="mx-auto flex flex-col gap-8">
        ...
        <div className="flex flex-col-reverse gap-8 lg:flex-row">
          ...
          <Card className="h-100 w-full max-w-75 bg-accent">
            <CardHeader>
              <CardTitle className="text-xl">Approval Panel</CardTitle>
            </CardHeader>

            <CardContent className="flex flex-col gap-4">
              <Button
                variant="outline"
                className="w-full justify-center bg-neutral-surface text-primary hover:text-primary"
              >
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <Badge
                  variant="outline"
                  className="h-9 w-fit rounded-md border-none bg-yellow-100 px-3 text-sm text-yellow-600"
                >
                  Pending Review
                </Badge>
              </div>
