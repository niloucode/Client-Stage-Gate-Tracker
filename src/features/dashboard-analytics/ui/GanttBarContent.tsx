 ...
 */
export function GanttBarContent({ occurrence }: GanttRenderEventProps<GanttBarEventData>) {
	...
	return (
		<div
			className={cn(
				...
				isPlanned ? "border-2 border-dashed bg-transparent" : "text-primary-foreground",
			)}
			style={{
