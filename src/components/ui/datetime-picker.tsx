		...
		return (
			<div className="flex h-8 items-center">
				...
				>
					<SelectTrigger
						ref={ref}
						className="w-15 h-8 text-xs focus:bg-accent focus:text-accent-foreground"
	...
	(
		...
		return (
			<Input
				...
				name={name || picker}
				className={cn(
					"w-10.5 h-8 text-center font-mono text-xs tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-none",
					className,
				)}
