...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          "flex flex-col sm:flex-row space-y-2 sm:space-y-0 justify-center",
        ...
        button_previous: cn(
          ...
          "h-6 w-6 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-3 top-3",
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "h-6 w-6 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-3 top-3",
        ),
        ...
        MonthCaption: ({ calendarMonth }) => {
          return (
            <div className="inline-flex gap-1.5">
              ...
              >
                <SelectTrigger className="w-fit gap-1 border-none p-0 h-6 text-xs font-semibold focus:bg-accent focus:text-accent-foreground">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {MONTHS.map((month) => (
    ...
    return (
      <div className="flex h-8 items-center">
        ...
        >
          <SelectTrigger
            ref={ref}
            className="w-[60px] h-8 text-xs focus:bg-accent focus:text-accent-foreground"
  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          "w-[42px] h-8 text-center font-mono text-xs tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-none",
          className,
        )}
