...
interface PackOptions {
	 ...
	 * free, so editing one schedule never re-indexes the surrounding ones. A
	 ...
	 * onto its neighbors stacks DOWN into the first free lane, and one dragged
...
function packTimedSegments<TData>(
	...
	for (const cluster of clusters) {
		// Per-lane occupancy INTERVALS, not a single running end: pass a claim
		...
		// there moves away or is deleted, its neighbor settles down into the
